...
const mansionSouthOfLonelyLodge = new Location(names[32], 'mansionSouthOfLonelyLodge', '/locationPics/season5/I5.jpg', [78, 154], [48, 64]); // Master's Mansion?
const dustyDivot = new Location(names[33], 'dustyDivot', '/locationPics/season5/F5.jpg', [78, 102], [46, 48]);
const buildingsEastOfJunkJunction = new Location(names[34], 'buildingsEastOfJunkJunction', '/locationPics/season5/C2.jpg', [6, 30], [18, 31]); // Seventy's Set? <-- Kinda looks like 70s show
