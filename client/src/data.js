...
const buildingsEastOfJunkJunction = new Location(names[34], 'buildingsEastOfJunkJunction', './placeHolder.jpg');
const siloNortheastOfSnobbyShores = new Location(names[35], 'siloNortheastOfSnobbyShores', './placeHolder.jpg');
